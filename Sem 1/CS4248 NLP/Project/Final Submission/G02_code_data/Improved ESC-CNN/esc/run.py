...
class Model(nn.Module):
    ...
    def __init__(self, feature_length):
        super().__init__()
        self.lin_length = math.ceil(feature_length/4) - 3
        self.linear1 = nn.Linear(self.lin_length, 1)
...
def train(model, train_dataset, batch_size, lr, weight_decay, num_epoch, device,
    ...
    optimizer = optim.Adam(model.parameters(), lr=1e-04, weight_decay=weight_decay)
