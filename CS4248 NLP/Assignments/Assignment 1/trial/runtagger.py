...
initial_state_probability, emission_probability, transition_probability):
    ...
    for state in states:
        ...
        V[0][state] = {
            PROBABILITY: initial_state_probability[state] + \
                                emission_probability[state].get(observation[0], unknown_emission),
            BACKPOINTER: None
        }
    ...
    for t in range(1, len(observation)):
        ...
        for state in states:
            ...
            max_emission_prob = max_transition_prob + emission_probability[state].get(observation[t], unknown_emission)
