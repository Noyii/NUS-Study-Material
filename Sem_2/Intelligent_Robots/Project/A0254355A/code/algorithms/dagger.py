...
class DAgger(InteractiveImitationLearning):
    ...
    def __init__(self, env, teacher, learner, horizon, intention_horizon, intention_sampling_mode, episodes,alpha=0.5, test=False):
        InteractiveImitationLearning.__init__(self, env, teacher, learner, horizon, intention_horizon, intention_sampling_mode, episodes, test)
        # expert decay
        self.p = alpha
        self.alpha = self.p
