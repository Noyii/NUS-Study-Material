...
class DDPG(object):
    def __init__(self, state_dim, action_dim, max_action, net_type, writer=None):
    ...
    def load(self, filename, directory):
        self.actor.load_state_dict(torch.load('{}/{}_actor.pt'.format(directory, filename), map_location=device))
        self.critic.load_state_dict(torch.load('{}/{}_critic.pt'.format(directory, filename), map_location=device))
