...
def test_factor_marginalize():
    ...
    factor = Factor(var=[0, 1, 2],
                    card=[2, 2, 2],
                    val=[0.2, 0.3, 0, 0, 0.4, 0.5, 0, 0])
    vars_to_marginalize_out = [1]

    correct = Factor(var=[0, 2],
                     card=[2, 2],
                     val=[0.2, 0.3, 0.4, 0.5])
    ...
    vars_to_marginalize_out = [1, 2]

    correct = Factor(var=[0],
                     card=[2],
                     val=[0.6, 0.8])
